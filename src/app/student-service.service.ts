...
export class StudentServiceService {
  ...
  getStdDetail(stdid){
    return this.http.get<Student>('http://34.69.145.117:32461/SWE645-HW3/students'+'/'+stdid)
  }

  getStudents()
  {
    return this.http.get<Student[]>('http://34.69.145.117:32461/SWE645-HW3/students');
  }

  setStudent(student){
    console.log(student);
    const url ='http://34.69.145.117:32461/SWE645-HW3/students'
